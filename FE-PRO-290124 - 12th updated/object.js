...
window.onload = function() {
  ...
  radioBtn.forEach(radio => {
    radio.addEventListener('change', function() {   //додає обробник подій, який буде викликатися, коли стан радіокнопки змінюється.
      radioBtn.forEach(rd => {                      //скасування вибору інших радіокнопок, коли вибрано одну
        if (rd !== this) {
          rd.checked = false;
        }
      });
...
// let textStr = "    Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos itaque vero laborum fugit harum! Quia, 
// cumque necessitatibus nemo veniam odit dolor impedit aspernatur, ipsa vitae minima quasi doloribus repellendus cupiditate!";
